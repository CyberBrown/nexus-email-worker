...
Cloudflare Email Worker that receives emails at `inbox@distributedelectrons.com` and processes them into Nexus items (tasks, ideas, notes, or raw inbox captures) via LLM classification.
...
1. Forward any email to `inbox@distributedelectrons.com`
